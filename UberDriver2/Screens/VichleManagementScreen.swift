...
struct VichleManagementScreen: View {
...
//            }
            ...
            Text("Vehicle management type of car ").font(.callout).multilineTextAlignment(.leading).lineLimit(2)
        ...
        }.frame(height: 10.0).navigationTitle(Text("Vehicle Management")
                            .font(.footnote))
        }
    }
}

struct VichleManagementScreen_Previews: PreviewProvider {
    static var previews: some View {
        VichleManagementScreen()
    }
}
